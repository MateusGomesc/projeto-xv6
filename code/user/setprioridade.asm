...
user/_setprioridade:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
   ...
   a:	1000                	addi	s0,sp,32
    if (argc != 3) {
   c:	478d                	li	a5,3
   e:	00f50b63          	beq	a0,a5,24 <main+0x24>
        printf("Uso correto: renice <pid> <prioridade>\n");
  12:	00001517          	auipc	a0,0x1
  16:	8de50513          	addi	a0,a0,-1826 # 8f0 <malloc+0xec>
  1a:	736000ef          	jal	ra,750 <printf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	304000ef          	jal	ra,324 <exit>
  24:	84ae                	mv	s1,a1
    }

    int pid = atoi(argv[1]);
  26:	6588                	ld	a0,8(a1)
  28:	1da000ef          	jal	ra,202 <atoi>
  2c:	892a                	mv	s2,a0
    int priority = atoi(argv[2]);
  2e:	6888                	ld	a0,16(s1)
  30:	1d2000ef          	jal	ra,202 <atoi>
  34:	84aa                	mv	s1,a0

    if (priority < 0 || priority > 19) {
  36:	0005071b          	sext.w	a4,a0
  3a:	47cd                	li	a5,19
  3c:	00e7fb63          	bgeu	a5,a4,52 <main+0x52>
        printf("Erro: A prioridade deve estar entre 0 (maxima) e 20 (minima).\n");
  40:	00001517          	auipc	a0,0x1
  44:	8d850513          	addi	a0,a0,-1832 # 918 <malloc+0x114>
  48:	708000ef          	jal	ra,750 <printf>
        exit(1);
  4c:	4505                	li	a0,1
  4e:	2d6000ef          	jal	ra,324 <exit>
    }
  ...
  5a:	90250513          	addi	a0,a0,-1790 # 958 <malloc+0x154>
  5e:	6f2000ef          	jal	ra,750 <printf>

    if (setpriority(pid, priority) == 0) {
  62:	85a6                	mv	a1,s1
  64:	854a                	mv	a0,s2
  66:	366000ef          	jal	ra,3cc <setpriority>
  6a:	e919                	bnez	a0,80 <main+0x80>
        printf("Sucesso: Prioridade do processo %d alterada!\n", pid);
  6c:	85ca                	mv	a1,s2
  6e:	00001517          	auipc	a0,0x1
  72:	92250513          	addi	a0,a0,-1758 # 990 <malloc+0x18c>
  76:	6da000ef          	jal	ra,750 <printf>
    } else {
    ...
    exit(0);
  7a:	4501                	li	a0,0
  7c:	2a8000ef          	jal	ra,324 <exit>
        printf("Erro: Nao foi possivel alterar a prioridade. O PID %d existe?\n", pid);
  80:	85ca                	mv	a1,s2
  82:	00001517          	auipc	a0,0x1
  86:	93e50513          	addi	a0,a0,-1730 # 9c0 <malloc+0x1bc>
  8a:	6c6000ef          	jal	ra,750 <printf>
  8e:	b7f5                	j	7a <main+0x7a>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 414:	5f850513          	addi	a0,a0,1528 # a08 <digits>
 418:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	538c8c93          	addi	s9,s9,1336 # a08 <digits>
 ...
 6f8:	30c90913          	addi	s2,s2,780 # a00 <malloc+0x1fc>
        for(; *s; s++)
